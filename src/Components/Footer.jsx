  ...
  return (
    <footer className="footerContainer  text-white py-4">
      <div className=" container-fluid">
        <div className="row">
          {/* Branding and Awards */}
          <div className="col-lg-3 col-md-6 mb-4 px-5">
            <h5 className="mb-5"> <img className="w-75" src="https://c.housingcdn.com/demand/s/client/common/assets/housing.820bbe77.png" alt="" /></h5>
          ...
          {/* QR Code and Apps */}
          <div className="col-lg-3 col-md-6 mb-4 text-center app">
          <div className="coming-soon">
              <h6 className="text-uppercase text-warning fw-bold mb-3">Coming Soon</h6>
              <p className=" mb-4 list">Exciting updates are on the way. Stay tuned!</p>
            </div>
           ...
           <img
            ...
            />
            <p className="mt-2 list ">Open camera & scan the QR code to Download the App</p>
           </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <small className="list">© 2024-25 Prasidhi Realty Solutions Pvt. Ltd</small>
        </div>
      </div>
    </footer>
  );
